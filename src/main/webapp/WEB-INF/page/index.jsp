...
<head>
    ...
    <link href="<c:url value='/ui_framework/down_file/font1.css'/>" rel='stylesheet' type='text/css'>
    <link rel="stylesheet" type="text/css" href="<c:url value='/ui_framework/lib/bootstrap/css/bootstrap.css'/>">
    <link rel="stylesheet" href="<c:url value='/ui_framework/lib/font-awesome/css/font-awesome.css'/>">

    <script src="<c:url value='/ui_framework/lib/jquery-1.11.1.min.js'/>" type="text/javascript"></script>

    <script src="<c:url value='/ui_framework/lib/jQuery-Knob/js/jquery.knob.js'/>" type="text/javascript"></script>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/ui_framework/stylesheets/theme.css'/>">
    <link rel="stylesheet" type="text/css" href="<c:url value='/ui_framework/stylesheets/premium.css'/>">
...
<div class="content">
    ...
    <div class="main-content">
            ...
            <div class="col-sm-6 col-md-6">
                <div class="panel panel-default">
                    ...
                    <div id="widget1container" class="panel-body collapse in">
                        <h2>Here's a Tip</h2>
                        <p>This template was developed with <a href="#"
        ...
        <footer>
            ...
            <p class="pull-right">A <a href="#" target="_blank">Free Bootstrap
...
<script src="<c:url value='/ui_framework/lib/bootstrap/js/bootstrap.js'/>"></script>
<script type="text/javascript">
    $("[rel=tooltip]").tooltip();
    $(function () {
